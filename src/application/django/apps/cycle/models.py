...
from src.application.django.apps.cycle.choices import C_STATUS_CYCLE, STATUS_CYCLE_ACTIVE
...
class CycleModel(models.Model):
    ...
    soros_levels: models.IntegerField(default=0)
    soros_percentage_profit = models.DecimalField(max_digits=5, decimal_places=2, default=0)
