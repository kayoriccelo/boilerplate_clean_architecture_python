...
from src.application.django.apps.management.choices import C_STATUS_MANAGEMENT, STATUS_MANAGEMENT_ACTIVE
...
class ManagementModel(models.Model):
    ...
    stop_win: models.DecimalField(max_digits=5, decimal_places=2)
